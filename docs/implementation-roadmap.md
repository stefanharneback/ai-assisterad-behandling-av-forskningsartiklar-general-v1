...
- Lägg till CLI och första tester.
...
- Använd structured output och evidenskrav för alla LLM-svar.

## M6 - Output, QA och kostnader

- Skriv `Resultat.xlsx`, `results.jsonl`, `run.sqlite` och `manifest.json`.
- Lägg provenance per cell i separat blad eller kommentar.
- Lägg review-flaggor, confidence och kostnadslogg.
