...
def _inventory_row(article: Article) -> dict[str, str]:
    return {
        ...
        "page_count": "" if article.page_count is None else str(article.page_count),
        "text_char_count": "" if article.text_char_count is None else str(article.text_char_count),
        "text_layer_error": article.text_layer_error or "",
