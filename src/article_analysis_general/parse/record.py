...
from article_analysis_general.store.record import Article, ArticleRecord, ArticleSource, ExtractionStatus
...
def build_local_article_record(article: Article, *, corpus: Path) -> ArticleRecord:
    ...
    return ArticleRecord(article=parsed_article, sections=parsed.sections, chunks=parsed.chunks)
